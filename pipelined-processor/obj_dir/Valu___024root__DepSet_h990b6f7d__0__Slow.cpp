...
#endif
                VL_FATAL_MT("src/alu.sv", 4, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Valu___024root___ctor_var_reset(Valu___024root* vlSelf) {
    ...
    // Body
    vlSelf->src_a_i = VL_RAND_RESET_I(32);
    vlSelf->src_b_i = VL_RAND_RESET_I(32);
    ...
    vlSelf->negative_o = VL_RAND_RESET_I(1);
